...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      {/* Texture overlay for the entire page */}
      <TextureOverlay />
      
      {/* Decorative SVG blob top-left */}
      <div className="absolute top-0 left-0 w-96 h-96 -translate-x-1/2 -translate-y-1/2 opacity-25 pointer-events-none z-0">
      ...
      {/* Decorative SVG blob bottom-right */}
      <div className="absolute bottom-0 right-0 w-96 h-96 translate-x-1/3 translate-y-1/4 opacity-15 pointer-events-none z-0">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="section bg-muted/50 dark:bg-background/30 relative overflow-hidden">
        {/* Grain texture overlay specific to this section */}
      ...
      <section className="py-16 bg-primary dark:bg-primary/90 text-white text-center relative overflow-hidden">
